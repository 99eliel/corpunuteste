...
t=once(t,'    const bs = [...p.querySelectorAll("button")].filter(b => !b.closest("#faccoesAbasCorte"));','    const bs = [...p.querySelectorAll("button")];',"seletor de abas legado")
...
t=once(t,'    s.textContent = `#faccoesAbasCorte{display:none!important}#faccoes tr.${CLASSE_TIPO_INCOMPATIVEL}', '    s.textContent = `#faccoes tr.${CLASSE_TIPO_INCOMPATIVEL}', "estilo legado das abas")
